...
// Polyfill trimming/AOT attributes for target frameworks that don't include them (net472, netstandard2.0, net35).
// The compiler recognizes these attributes by name regardless of the declaring assembly,
// so the trimmer and AOT analyzers will pick them up on net5.0+ where the real framework types are used.
