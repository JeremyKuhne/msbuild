...
namespace Microsoft.Build.Internal
{
    ...
    internal static class AvailableStaticMethods
    {
        ...
        /// <c>GetConstructor(s)</c>, and <c>FindMembers</c> with <c>BindingFlags.Public</c> (see
        /// Expander.Function.Execute and LateBindExecute). Events, nested types, interfaces, and
        /// non-public members are never reflected over - the sole exception is IntrinsicFunctions'
        /// non-public methods, added on its entry below.
        /// </summary>
        ...
        // makes the IL2072/IL2074/IL2096 suppressions in Expander honest under trimming. Keep in sync
        // with the entries added below.
        ...
        [DynamicDependency(PropertyFunctionMembers | DynamicallyAccessedMemberTypes.NonPublicMethods, typeof(IntrinsicFunctions))]
