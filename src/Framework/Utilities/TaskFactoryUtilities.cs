...
namespace Microsoft.Build.Shared
{
    ...
    internal static class TaskFactoryUtilities
    {
        ...
        [RequiresUnreferencedCode("Loads task assemblies by path.")]
        ...
        [RequiresUnreferencedCode("Loads task assemblies dynamically.")]
        ...
        [RequiresUnreferencedCode("Loads assemblies dynamically from search directories.")]
